...
//! makes, and is held to it the same way.
//!
...
pub fn printed_refusals() -> Result<Vec<String>, Box<dyn Error>> {
    ...
    // The lines a launch writes about the save it read live in their own module,
    // and the split is by responsibility rather than by line count: none of them
