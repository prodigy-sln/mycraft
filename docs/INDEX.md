...
| File | Purpose | Sources |
|------|---------|---------|
| gameplay.md | Player-facing controls and movement feel: WASD walking, mouse look, jump, cursor capture; saving on quit and resuming on relaunch, and what a player sees and can do when a save can't be loaded outright | SPEC-005, SPEC-009 |
